...
A comprehensive ML pipeline foundation with cloud integration using LocalStack for AWS mocking, featuring DynamoDB and S3 storage with full CRUD operations.
...
5. Run the test suite: `./docker/run-cloud-tests.sh`
